    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(max_length=13, null=True, unique=True, verbose_name='Mobile Number')),
                ...
                ('gender', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female'), ('B', 'Non-Binary')], max_length=1, null=True, verbose_name='Gender')),
